...
//NOTE:
    // 1. Note that CURRENT PID of Parent_process and PARENT PID of Child_process is same (cuz even if the Child_process was sleeping but wait(NULL) made the Parent_process wait for Child_process to complete its execution)
